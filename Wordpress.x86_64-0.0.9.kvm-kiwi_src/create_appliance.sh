...
image_file='image/Wordpress.x86_64-0.0.9'
image_arch='x86_64'
schema_ver='5.2'
base_system='SLES11_SP3'
uefi_enabled='false'
declare -a repos=("SLE11-HAE-SP3-Updates" "SLES 11 SP3 x86_64" "SLE 11 SP3 SDK x86_64" "SLES 11 SP3 Updates x86_64" "SLE11-HAE-SP3-Pool" "SLE 11 SP3 SDK Updates x86_64")
